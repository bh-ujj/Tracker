package com.ujwal.locate2.view.faculties;
...
import com.ujwal.locate2.databinding.ActivityFacultyLoginBinding;
...
public class FacultyLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Faculties Log In");
        ...
        Glide.with(FacultyLogin.this).load(R.drawable.realtime).into(imageView);
